...
exports.generateSampleOutput = void 0;
var actions_1 = require("./actions");
function generateSampleOutput() {
    return __awaiter(this, void 0, void 0, function () {
        var swiggyUrl, targetDate, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    swiggyUrl = "https://play.google.com/store/apps/details?id=in.swiggy.android";
                    targetDate = new Date();
                    console.log("Starting sample output generation for Swiggy...");
                    return [4 /*yield*/, actions_1.handleProcessReviews(swiggyUrl, targetDate)];
                case 1:
                    result = _a.sent();
                    if (result.error) {
